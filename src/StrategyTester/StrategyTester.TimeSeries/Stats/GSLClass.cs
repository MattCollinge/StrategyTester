...
namespace tripletfinder
{
  ...
  //MYMATRIXDIVIDE = MMYMULTIPLY(MMYMULTIPLY(MYMATRIXINVERSE(MMYMULTIPLY(xTranspose, xMat)), xTranspose), yMat)
    ...
    public class GSL
    {
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_alloc")]
        //public static extern System.IntPtr gsl_vector_alloc([System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.SysUInt)] uint n);
        public static extern System.IntPtr gsl_vector_alloc(int n);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_alloc")]
        public static extern System.IntPtr gsl_matrix_alloc(int m, int n);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_get_size1")]
        public static extern int gsl_matrix_get_size1(IntPtr m);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_get_size")]
        public static extern int gsl_vector_get_size(IntPtr v);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_get_size2")]
        public static extern int gsl_matrix_get_size2(IntPtr m);


        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_complex_alloc")]
        public static extern IntPtr gsl_vector_complex_alloc(int n);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_complex_alloc")]
        public static extern IntPtr gsl_matrix_complex_alloc(int nr, int nc);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_eigen_nonsymmv_alloc")]
        public static extern IntPtr gsl_eigen_nonsymmv_alloc(int n);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_eigen_nonsymmv")]
        public static extern int gsl_eigen_nonsymmv(IntPtr A,
            IntPtr eval, IntPtr evec, IntPtr w);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_eigen_nonsymmv_free")]
        public static extern void gsl_eigen_nonsymmv_free(IntPtr w);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_complex_getsize")]
        public static extern int gsl_vector_complex_getsize(IntPtr v);


        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_complex_getsize1")]
        public static extern int gsl_matrix_complex_getsize1(IntPtr v);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_complex_getsize2")]
        public static extern int gsl_matrix_complex_getsize2(IntPtr v);



        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_complex_getboth")]
        public static extern void gsl_vector_complex_getboth(IntPtr v, int i, out double realval, out double imagval);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_complex_getboth")]
        public static extern void gsl_matrix_complex_getboth(IntPtr m, int i, int j, out double realval, out double imagval);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_eigen_nonsymmv_sort")]
        public static extern int gsl_eigen_nonsymmv_sort(
            IntPtr eval, IntPtr evec, gsl_eigen_sort_t sortorder);


        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_eigen_jacobi")]
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_multifit_linear")]
        public static extern int gsl_multifit_linear(IntPtr X,
                     IntPtr y, IntPtr c, IntPtr cov, out double chisq, IntPtr work);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_permutation_alloc")]
        public static extern IntPtr gsl_permutation_alloc(int n);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_memcpy")]
        public static extern int gsl_matrix_memcpy(IntPtr dest, IntPtr src);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_linalg_LU_decomp")]
        public static extern int gsl_linalg_LU_decomp(IntPtr A, IntPtr p, out int signum);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_linalg_LU_invert")]
        public static extern int gsl_linalg_LU_invert(IntPtr LU, IntPtr p, IntPtr inverse);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_free")]
        public static extern void gsl_matrix_free(IntPtr m);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_permutation_free")]
        public static extern void gsl_permutation_free(IntPtr p);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_get")]
        public static extern double gsl_matrix_get(IntPtr m, int i, int j);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_blas_dgemm")]
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_set")]
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_set")]
        public static extern void gsl_matrix_set(IntPtr v, int i, int j, double x);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_set_all")]
  ...
  GSL_EIGEN_SORT_ABS_DESC
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_div_elements")]
        public static extern int gsl_matrix_div_elements(IntPtr m1, IntPtr m2);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_multimin_fminimizer_set")]
        public static extern int gsl_multimin_fminimizer_set(IntPtr s, IntPtr f, IntPtr x, IntPtr step_size);


        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_matrix_transpose_memcpy")]
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_vector_get")]
        public static extern double gsl_vector_get(IntPtr v, int i);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_multimin_fminimizer_alloc")]
        public static extern IntPtr gsl_multimin_fminimizer_alloc(IntPtr T, uint i);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_multimin_fminimizer_iterate")]
        public static extern int gsl_multimin_fminimizer_iterate(IntPtr s);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_multimin_fminimizer_size")]
        public static extern double gsl_multimin_fminimizer_size(IntPtr s);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_multimin_test_size")]
        ...
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_rng_env_setup")]
        ...
        /// Return Type: gsl_rng*
        ///T: gsl_rng_type*
        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_rng_alloc")]
        public static extern System.IntPtr gsl_rng_alloc(IntPtr T);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_rng_set")]
        public static extern void gsl_rng_set(IntPtr T, int seed);

        [System.Runtime.InteropServices.DllImportAttribute("libgsl_d.dll", EntryPoint = "gsl_ran_gaussian")]
